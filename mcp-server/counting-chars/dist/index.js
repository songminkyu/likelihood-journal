...
function countCharOccurrences(text, search, caseSensitive) {
    if (!caseSensitive) {
...
function countWordOccurrences(text, word, caseSensitive, exactMatch) {
    if (!caseSensitive) {
        text = text.toLowerCase();
        ...
        tools: [
            {
                ...
                inputSchema: zodToJsonSchema(CountCharsArgsSchema),
            },
            {
                name: "count_words",
                description: "Count occurrences of a specific word within text. By default, performs exact word " +
                ...
                inputSchema: zodToJsonSchema(CountWordsArgsSchema),
            },
            {
                name: "text_stats",
                description: "Analyze text to provide comprehensive statistics including character count, " +
                ...
                inputSchema: zodToJsonSchema(GetTextStatsArgsSchema),
            },
        ],
    };
});
